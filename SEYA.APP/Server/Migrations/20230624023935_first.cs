        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroComprobante = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ClienteId = table.Column<int>(type: "int", nullable: false),
                    CantidadCuotas = table.Column<int>(type: "int", nullable: false),
                    ValorTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Pendiente = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cuotas_Deudas_CuentaId",
                        column: x => x.CuentaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Funcionarios_Roles_RolId",
                        column: x => x.RolId,
            ...
            migrationBuilder.InsertData(
                table: "Funcionarios",
                columns: new[] { "Id", "Apellido", "Cedula", "Correo", "Direccion", "Nombre", "RolId", "Telefono" },
                values: new object[] { 1, "Administrador", "0.000.000", "administrador@gmail.com", "CDE", "Administrador del sistema", 1, "0984444420" });

            migrationBuilder.CreateIndex(
                name: "IX_Cuotas_CuentaId",
                table: "Cuotas",
                column: "CuentaId");

            migrationBuilder.CreateIndex(
                name: "IX_Funcionarios_RolId",
                table: "Funcionarios",
                column: "RolId");
